...
function Footer(){
    ...
    return(
        ...
        <div class="container mx-auto flex  flex-wrap gap-16   items-center justify-evenly w-full ">

            <div class="flex flex-col items-start gap-6 pl-20 md:flex-row md:justify-evenly lg:flex-row w-full" >
