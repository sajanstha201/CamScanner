export const Home=()=>{
    ...
    <div class="w-full h-auto md:h-[55vh]  flex flex-col  md:flex-row items-center gap-10 md:gap-20 justify-center p-4 md:p-0">
        <div class="bg-white h-80  w-[50%] md:w-[25%] rounded-lg border-grey-700 border shadow-sm shadow-zinc-700 p-4 flex flex-col justify-center items-center hover:shadow-cyan-500/50">
            <img class="h-20" src="img/3rd.png" alt="PDF Conversion"></img>
        ...
        <div class="bg-white h-80  w-[50%]  md:w-[25%] rounded-lg border-zinc-900 border shadow-sm shadow-zinc-700 p-4 flex flex-col justify-center items-center hover:shadow-cyan-500/50">
            <img class="h-20" src="img/2nd.png" alt="Table Extraction"></img>
        ...
        <div class="bg-white h-80 w-[50%]  md:w-[25%] rounded-lg border-zinc-900 border shadow-sm shadow-zinc-700 p-4 flex flex-col justify-center items-center hover:shadow-cyan-500/50">
            <img class="h-20" src="img/1st.png" alt="Document Analysis"></img>
