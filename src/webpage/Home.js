...
export const Home=()=>{
    ...
    <div class={`w-full h-auto md:h-[55vh]  flex flex-wrap items-center gap-10 md:gap-20 justify-center p-4 md:p-0`}>
        ...
        <Link to='/table-extraction' class="no-underline bg-white h-100  w-[50%]  md:w-[25%] rounded-lg border-zinc-900 border shadow-sm shadow-zinc-700 p-4 flex flex-col justify-center items-center hover:shadow-cyan-500/50">
            ...
            {!isMobile&&<p class="text-zinc-700 text-sm md:text-base">Extract data tables from PDFs and save results to CSV, XLS, XLSX, and other formats. With this tool, you can get any statistical data in a convenient format for processing.</p>}
        </Link>
        <Link  to='/document-analysis' class="no-underline bg-white h-100 w-[50%]  md:w-[25%] rounded-lg border-zinc-900 border shadow-sm shadow-zinc-700 p-4 flex flex-col justify-center items-center hover:shadow-cyan-500/50">
            ...
            {!isMobile&&<p class="text-zinc-700 text-sm md:text-base">Our innovative, user-friendly, and reliable document analysis tool offers intelligent document conversions, OCR, full API, and workflow automation as per your needs.</p>}
        </Link>
        <Link  to='/image-conversion' class="no-underline bg-white h-100 w-[50%]  md:w-[25%] rounded-lg border-zinc-900 border shadow-sm shadow-zinc-700 p-4 flex flex-col justify-center items-center hover:shadow-cyan-500/50">
            ...
            {!isMobile&&<p class="text-zinc-700 text-sm md:text-base">Easily convert your PDF pages into high-quality images. Just upload your PDF, select your desired image format, and download the results in seconds. Fast, secure, and user-friendly!</p>}
        </Link>
    </div>
        </>
    )
